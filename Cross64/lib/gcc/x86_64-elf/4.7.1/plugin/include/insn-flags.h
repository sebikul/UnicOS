...
#define HAVE_avx_movups256 ((TARGET_SSE && !(MEM_P (operands[0]) && MEM_P (operands[1]))) && (TARGET_AVX))
#define HAVE_sse_movups (TARGET_SSE && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_avx_movupd256 ((TARGET_SSE && !(MEM_P (operands[0]) && MEM_P (operands[1]))) && (TARGET_AVX))
#define HAVE_sse2_movupd ((TARGET_SSE && !(MEM_P (operands[0]) && MEM_P (operands[1]))) && (TARGET_SSE2))
#define HAVE_avx_movdqu256 ((TARGET_SSE2 && !(MEM_P (operands[0]) && MEM_P (operands[1]))) && (TARGET_AVX))
...
#define HAVE_atomic_compare_and_swap_singleqi (TARGET_CMPXCHG)
#define HAVE_atomic_compare_and_swap_singlehi (TARGET_CMPXCHG)
#define HAVE_atomic_compare_and_swap_singlesi (TARGET_CMPXCHG)
#define HAVE_atomic_compare_and_swap_singledi ((TARGET_CMPXCHG) && (TARGET_64BIT))
#define HAVE_atomic_compare_and_swap_doubledi (!TARGET_64BIT && TARGET_CMPXCHG8B && !flag_pic)
#define HAVE_atomic_compare_and_swap_doubleti (TARGET_64BIT && TARGET_CMPXCHG16B)
